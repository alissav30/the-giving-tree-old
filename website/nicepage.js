              ...
              , Carousel = function() {
                ...
                e.to = function t(index) {
                    ...
                    if (!(index > this._items.length - 1 || index < 0)) {
                        if (this._isSliding)
                            return s["default"](this._element).one(A, (function() {
                                return e.to(index)
                            }
                            )),
                            void 0;
                ...
                e._getItemByDirection = function t(e, i) {
                    var n = e === x, o = e === _, a = this._getItemIndex(i), s = this._items.length - 1, l;
                ...
                e._slide = function e(i, n) {
                    var o = this, a = this._element.querySelector(G), u = this._getItemIndex(a), f = n || a && this._getItemByDirection(i, a), c = this._getItemIndex(f), h = Boolean(this._interval), p, m, v, g;
                    if (i === x)
                        p = W,
                        m = Z,
                        v = C;
                        ...
                        if (a && f) {
                            ...
                            if (s["default"](this._element).hasClass($)) {
                                ...
                                s["default"](a).one(l["default"].TRANSITION_END, (function() {
                                    s["default"](f).removeClass(p + " " + m).addClass(B),
        ...
        !function(a, factory) {
            ...
            var t = function(template, t, items, e) {
                ...
                var l = function() {
                    ...
                    x: 0,
                    y: 0
                }, w, b, x, _ = {}, C, T, S, A, k, I, E = 0, L = {}, O = {
                    x: 0,
                    y: 0
                }, F, M, z = 0, P, N, H, $, B, V, U = true, W, Z = [], j, X, K, G, Y, J, tt, nt = {}, ot = false, rt, at = function(t, e) {
                ...
                }, Bt = 30, Vt = 10, Ut, Wt, Zt = {}, jt = {}, Xt = {}, Kt = {}, Gt = {}, Yt = [], Qt = {}, Jt, te = [], ee = {}, ie, ne, oe, re = 0, ae = {
                    x: 0,
                    y: 0
                }, se = 0, le, ue, fe, ce, pe, ve, ge, ye, we, be, xe, _e = {
                    x: 0,
                    y: 0
                }, Ce, Te, Se = {
                    x: 0,
                    ...
                    var i, o = 0, a = y[t] + e[t], l, u = e[t] > 0, f = _e.x + e.x, c = _e.x - Qt.x, h, p;
...
* Copyright (c) 2019 Dmitry Semenov; */
        !function(a, factory) {
            ...
            var t;
            return function(t, e) {
                var i = this, n = false, o = true, a, s, l, u, f, c, h, p = true, m, v, g, y, w, b, x, _, C = {
                    barsSize: {
                        top: 44,
                        bottom: "auto"
                    },
 ...
 */
            !function(e, i, n) {
                ...
                var ot = function() {
                        ...
                        case v:
                            ...
                            if (T * T + c * c < 49) {
                                if (!P.test(t.tagName)) {
                                    ...
                                    A.initMouseEvent("click", true, true, e.view, 1, f.screenX, f.screenY, f.clientX, f.clientY, e.ctrlKey, e.altKey, e.shiftKey, e.metaKey, 0, null),
                                    t.dispatchEvent(A)
                                }
                                return
                            }
                  ...
                  , rt = function() {
                    ...
                    p = Dt.length; h < p; h++)
                        ...
                        u = (a = i.keyFrames).length; s < u; s++) {
                            ...
                            if ("relative" === c.mode)
                                pt(n),
                                c.frame = Ot.relativeToAbsolute(o, c.anchors[0], c.anchors[1]) - m,
                                pt(n, true);
                            if (c.frame += v,
                            zt)
                    ...
                    p = Dt.length; h < p; h++) {
                        for (s = 0,
                        u = (a = (i = Dt[h]).keyFrames).length; s < u; s++)
                  ...
                  , at = function(t, e) {
                    for (var i = 0, n = Dt.length; i < n; i++) {
                        var o = Dt[i], l = o.element, u = o.smoothScrolling ? t : e, f = o.keyFrames, c = f.length, h = f[0], p = f[f.length - 1], m = u < h.frame, v = u > p.frame, x = m ? h : p, _ = o.emitEvents, C = o.lastFrameIndex, T, S;
                        if (m || v) {
                ...
                }, Ot, Dt, Ft, Mt, zt, Pt = 0, Rt = 1, Nt, Ht, qt = "down", $t = -1, Bt = kt(), Vt = 0, Ut = 0, Wt = false, Zt, jt, Xt, Kt, Gt, Yt = 0, Qt, Jt = false, te = 0, ee, ie = [], ne;
                if ("function" == typeof define && define.amd)
                    define([], (function() {
                        return a
                    }
...
*/
    ...
    7557: function(t, e, i) {
        ...
        window._npInitMenuLink = function t(e, i) {
            var o = n("body"), a = /#.*?$/, s = o.attr("data-home-page-name"), l = o.attr("data-home-page"), pageTitle = n("title").text().trim(), nav, u = e.closest(".u-menu").attr("data-submenu-level") || "on-click", f = e.attr("href") || "", c = (e[0].href || "").replace(a, ""), h = f.replace(a, ""), p = s || pageTitle, m = e.text().trim(), v = f.replace(/^[^#]+/, "");
            if (!v || "#" === v || !n(v).length)
 ...
 */
    ...
    7571: function(t, e, i) {
        ...
        function o(t) {
            var e = t.currentTarget, i, n = l(e).closest(".u-gallery-item").data("zoom_click"), o = e.getBoundingClientRect(), a = e.querySelector("img"), s = t.clientX, u = t.clientY, f = t.originalEvent.changedTouches;
            if (!n && !f) {
                l(e).addClass("hover");
                var c = s - o.x
                  , h = u - o.y;
    ...
    7574: function(t, e, i) {
        ...
        !function(e, factory) {
            ...
            var s = i.documentElement, l = e.HTMLPictureElement, u = "addEventListener", f = "getAttribute", c = e[u].bind(e), h = e.setTimeout, p = e.requestAnimationFrame || h, m = e.requestIdleCallback, v = /^picture$/i, g = ["load", "error", "lazyincluded", "_lazyloaded"], y = {}, w = Array.prototype.forEach, b = function(t, e) {
                if (!y[e])
                    ...
                    ut++; e < t; e++)
                        if (y[e] && !y[e]._lazyRace)
                            if (!(!rt || o.prematureUnveil && o.prematureUnveil(y[e]))) {
                                ...
                                (J = rect.bottom) >= c && (K = rect.top) <= X && (Y = rect.right) >= c * g && (G = rect.left) <= j && (J || Y || G || K) && (a.loadHidden || ct(y[e])) && (V && lt < 3 && !h && (W < 3 || ut < 4) || dt(y[e], u))) {
                                    if (xt(y[e]),
                                    l = true,
                                    lt > 9)
                                        break
                                } else if (!l && V && !n && lt < 4 && ut < 4 && W > 2 && (B[0] || a.preloadAfterLoad) && (B[0] || !h && (J || Y || G || K || "auto" != y[e][f](a.sizesAttr))))
                                    n = B[0] || y[e]
                            } else
                                xt(y[e]);
                    if (n && !l)
